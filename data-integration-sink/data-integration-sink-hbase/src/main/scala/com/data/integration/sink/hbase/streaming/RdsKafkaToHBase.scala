...
import com.data.integration.sink.hbase.HBaseConfiguration
...
/**
  *
  */
object RdsKafkaToHBase {

  def main(args: Array[String]): Unit = {

    val userConf = new HBaseConfiguration

    val sparkConf = new SparkConf().setAppName("RdsKafkaToHBase")//.setMaster("local[*]")
    ...
    val broadcastConf: Broadcast[HBaseConfiguration] = ssc.sparkContext.broadcast(userConf)
