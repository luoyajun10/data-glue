...
import com.data.integration.sink.kudu.KuduConfiguration
...
object RdsKafkaToKudu {

  def main(args: Array[String]): Unit = {

    val userConf = new KuduConfiguration

    val sparkConf = new SparkConf().setAppName("RdsKafkaToKudu")//.setMaster("local[*]")
    ...
    val broadcastConf: Broadcast[KuduConfiguration] = ssc.sparkContext.broadcast(userConf)
