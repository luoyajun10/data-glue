...
import com.data.integration.core.OperationParser
import com.data.integration.core.constant.Constants
import com.data.integration.core.filter.TableWhiteListFilter
import com.data.integration.core.model.Operation
import com.data.integration.core.util.KafkaConsumerUtils
import com.data.integration.sink.mysql.MySQLConfiguration
...
object RdsKafkaToMySQL {

  def main(args: Array[String]): Unit = {

    val userConf = new MySQLConfiguration

    val sparkConf = new SparkConf().setAppName("RdsKafkaToMySQL")//.setMaster("local[*]")
    ...
    val broadcastConf: Broadcast[MySQLConfiguration] = ssc.sparkContext.broadcast(userConf)
